...
export function startFixtureWorker(extraEnv = {}) {
  ...
  return new Promise((resolve, reject) => {
    const child = spawn(process.execPath, ["server/dist/worker.js", "--once"], {cwd: process.cwd(), windowsHide: true, stdio: ["ignore", "pipe", "pipe"], env: {...process.env, STORYVIDEOGEN_NODE_LOG_LEVEL: "silent", STORYVIDEOGEN_DATABASE_PATH: databasePath, STORYVIDEOGEN_MIGRATIONS_DIR: "server/migrations", STORYVIDEOGEN_STORAGE_ROOT: `output/e2e/${runId}/assets`, STORYVIDEOGEN_WORKER_ROOT: `output/e2e/${runId}/worker`, STORYVIDEOGEN_WORKER_LEASE_SECONDS: "5", STORYVIDEOGEN_WORKER_FIXTURE_MODE: "1", ...extraEnv}});
